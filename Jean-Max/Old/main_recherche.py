from function_distance import *
imagesPath="D:/MIR/Data"
featuresPath="D:/MIR/Indicateur"
...
listFeatureName=os.listdir(featuresPath)
featureNumber = len(listFeatureName)

for featureName in listFeatureName[5:]:
    print("---> " + featureName)

    featurePath = featuresPath + "/" + featureName
    ...
    for requestName in listRequestName:
        ...
        total = evaluation1(listDistance, requestBrand)
        finalTotal += total

    print("Somme :" + str(finalTotal))
    print("50 :")
    print("   Rappel : ")
